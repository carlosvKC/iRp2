...
+ (NSDictionary *)dictionaryForURL:(NSString *)path error:(NSError **)errorPointer
{
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict
{
    ...
    for (NSString *key in attributeDict) {
        NSMutableString *itm = [[attributeDict objectForKey:key] mutableCopy];
        [itm stringByReplacingOccurrencesOfString:@"&" withString:@" and "];
        [childDict setValue:itm  
