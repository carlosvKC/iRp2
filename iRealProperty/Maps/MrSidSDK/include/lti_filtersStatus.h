...
#define LTI_STS_Filters_InvalidDynamicRange           50217
LT_STATUSSTRING_ADD(LTI_STS_Filters_InvalidDynamicRange, "invalid dynamic range")
...
#define LTI_STS_Filters_DuplicateBandsNotSupported    50239
LT_STATUSSTRING_ADD(LTI_STS_Filters_DuplicateBandsNotSupported, "filter does not support duplicate bands in the band selection")
