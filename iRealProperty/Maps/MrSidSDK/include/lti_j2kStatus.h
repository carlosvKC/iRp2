...
LT_STATUSSTRING_ADD(LTI_STS_J2K_EncodingApplicationNotIdentified, "The application did not identify itself")
...
LT_STATUSSTRING_ADD(LTI_STS_J2K_BadBandList, "can not select a band more than once")
