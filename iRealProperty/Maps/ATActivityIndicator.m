...
static ATActivityIndicator *currentIndicator = nil;
...
+ (ATActivityIndicator *)currentIndicator
{
	if (currentIndicator == nil)
	{
		...
		currentIndicator = [[ATActivityIndicator alloc] initWithFrame:centeredFrame];
...
{
//#warning - Misc - Fix this enumeration when I have time.
    // https://developer.apple.com/library/ios/DOCUMENTATION/UIKit/Reference/UIApplication_Class/Reference/Reference.html#//apple_ref/c/tdef/UIInterfaceOrientation
	...
	if (orientation == UIDeviceOrientationPortraitUpsideDown)
		self.transform = CGAffineTransformRotate(CGAffineTransformIdentity, ATdegreesToRadians(180));	
    
	else if (orientation == UIDeviceOrientationPortrait)
		self.transform = CGAffineTransformRotate(CGAffineTransformIdentity, ATdegreesToRadians(0)); 
	
	else if (orientation == UIDeviceOrientationLandscapeLeft)
		self.transform = CGAffineTransformRotate(CGAffineTransformIdentity, ATdegreesToRadians(90));	
